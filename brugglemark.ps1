...
function brugglemark {
    ...
    .DESCRIPTION
        ...
        Created by David Prefer (pronounced Pree-fer) as a proof of concept for an academic research paper ("Bookmark Bruggling: Novel Data Exfiltration with Brugglemark"). The paper can be found at https://www.sans.org/white-papers.
    .LINK
